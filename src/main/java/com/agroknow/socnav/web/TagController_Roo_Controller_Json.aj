...
privileged aspect TagController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> TagController.jsonFindTagsByTagging(@RequestParam("tagging") Tagging tagging) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
    ...
    @ResponseBody
    public ResponseEntity<String> TagController.jsonFindTagsByValueLike(@RequestParam("value") String value) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
