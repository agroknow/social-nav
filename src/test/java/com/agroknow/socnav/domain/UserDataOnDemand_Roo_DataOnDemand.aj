...
privileged aspect UserDataOnDemand_Roo_DataOnDemand {
    ...
    public User UserDataOnDemand.getNewTransientUser(int index) {
        ...
        setRemote_id(obj, index);
        return obj;
    }
    
    public void UserDataOnDemand.setMetadata_uri(User obj, int index) {
        String metadata_uri = "metadata_uri_" + index;
        obj.setMetadata_uri(metadata_uri);
    }
    
    public void UserDataOnDemand.setRemote_id(User obj, int index) {
        Long remote_id = new Integer(index).longValue();
        obj.setRemote_id(remote_id);
    }
